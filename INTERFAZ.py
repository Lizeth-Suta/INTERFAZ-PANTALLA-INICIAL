...
class EntreMontañasYLeyendas:
    def __init__(self, root):
        ...
        # Botón de Municipio
        self.btn_municipio = tk.Button(self.root, text="Municipio", font=("Times New Roman", 14), bg="#4682B4", fg="white", command=self.abrir_municipio)
    ...
    def abrir_municipio(self):
        ...
        municipios = ["Fuquene", "Susa", "Simijaca", "Guacheta", "Cucunubá", "Carmen de Carupa", "Lenguazaque", "Sutatausa", "Tausa", "Ubaté"]
